...
class WC_Rakuten_Pay_Credit_Card_Gateway extends WC_Payment_Gateway_CC {
  ...
  public function checkout_scripts() {
    if ( is_checkout() ) {
      ...
      wp_enqueue_script( 'rakuten-pay-credit-card', plugins_url( 'assets/js/credit-card' . $suffix . '.js', plugin_dir_path( __FILE__ ) ), array( 'jquery', 'jquery-blockui', 'jquery-inputmask', 'rakuten-pay-library' ), WC_Rakuten_Pay::VERSION, true );
  ...
  private function custom_shipping_checkout_fields( $fields ) {
    ...
    $shipping_fields['shipping_number']['priority'] = 80;
    ...
    $new_shipping_fields = array(
      ...
      array(
        ...
        'shipping_document'  => array(
          ...
          'placeholder'     => __( 'Document', 'placeholder', 'woocommerce' ),
          'required'        => true,
          'class'           => array( 'form-row-wide' ),
          'clear'           => true
        )
      ...
      array(
        ...
        'shipping_district'  => array(
          ...
          'placeholder'     => __( 'District', 'placeholder', 'woocommerce' ),
          'required'        => true,
          'class'           => array( 'form-row-wide' ),
          'clear'           => true
        )
